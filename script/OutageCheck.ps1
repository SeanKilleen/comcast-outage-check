$unfilteredLogName = "syslog.log"
$filteredLogName = "filteredSyslog.log"
$csvName = "logs.csv"

Remove-Item -Force $filteredLogName -ErrorAction Ignore

Get-Content $unfilteredLogName | Select-String -Pattern "WAN1_(OFF|ON)" | Set-Content $filteredLogName
...
$deduped | Export-Csv $csvName -NoTypeInformation